...
db.define_table('posts',
    ...
    Field('post_status','string', requires=IS_IN_SET(['publish', 'auto-draft', 'inherit', 'draft', 'pending'])),
    Field('comment_status','string', requires=IS_IN_SET(['open', 'closed'])),
    Field('ping_status','string', requires=IS_IN_SET(['open', 'closed'])),
